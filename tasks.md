...
## 当前任务
**Phase 4 — P4.3.2+P4.3.3 方向信号准确率 & 用户反馈** (正在执行)

P4.1 关联引擎 ✅ P4.2 回测框架 ✅ P4.3.1 准确率记录 ✅
...
### P4.3 准确率追踪 & 自改进
- [x] **P4.3.1** 分类准确率记录 ✅ PR #31
  - AI 分类 vs 实际结果对比, 17 tests
  - 2 轮 review（Codex 开发 + CC review）
- [ ] **P4.3.2+P4.3.3** 方向信号准确率 & 用户反馈（合并）
  - T+1h/1d/1w 方向准确率 breakdown
  - 置信度校准 + 最大误判列表
  - 用户反馈 correct/incorrect/partially_correct
- [ ] **P4.3.4** 自适应分类调整
  - 基于反馈调整分类权重
