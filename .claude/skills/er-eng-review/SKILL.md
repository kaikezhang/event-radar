# Event Radar — Paranoid Engineering Review
...
### 7. Test Coverage
- [ ] ≥10 tests per new feature
- [ ] Edge cases: empty response, malformed data, timeout, rate limit
- [ ] Dedup test: same ID twice → only one event emitted
- [ ] No real network calls — all mocked with `vi.fn()`
