...
import { Calendar, ChevronDown, Filter, Loader2, RotateCcw, Search, X } from 'lucide-react';
    ...
    <div className="space-y-4 pb-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <input
          ...
          className="rounded-lg border border-border-default bg-bg-surface px-2.5 py-1.5 text-xs text-text-primary focus:border-accent-default focus:outline-none"
        />
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none rounded-lg border border-border-default bg-bg-surface py-1.5 pl-2.5 pr-7 text-xs text-text-primary focus:border-accent-default focus:outline-none"
          >
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Ticker..."
            className="w-24 rounded-lg border border-border-default bg-bg-surface py-1.5 pl-7 pr-2 text-xs text-text-primary placeholder:text-text-tertiary focus:border-accent-default focus:outline-none"
          />
          {filters.ticker && (
            <button
              type="button"
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {alerts.map((alert) => (
            <div
              key={alert.id}
              className="cursor-pointer rounded-2xl transition-all hover:ring-1 hover:ring-accent-default/30"
          ...
          {hasMore && (
            <div className="flex justify-center pt-2">
              <button
                ...
                onClick={loadMore}
                disabled={isFetching}
                className="inline-flex items-center gap-2 rounded-xl border border-border-default bg-bg-surface px-4 py-2 text-sm font-medium text-text-primary transition hover:border-accent-default disabled:opacity-50"
              >
                {isFetching ? (
                  <>
