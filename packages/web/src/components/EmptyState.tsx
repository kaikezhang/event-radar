...
export function EmptyState({
  ...
  return (
    <div className="rounded-2xl border border-border-default bg-bg-surface/92 p-6 text-center shadow-[0_12px_32px_var(--shadow-color)]">
      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-overlay-light text-2xl">
