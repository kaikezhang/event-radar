...
/**
 * Routes all feed traffic to Discord. Web Push is added when the
 * confidence-based push policy allows it.
 *
 * Legacy severity-based routing uses the same Discord-first behavior.
 */
