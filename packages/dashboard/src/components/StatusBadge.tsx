...
const statusStyles: Record<string, string> = {
  ...
  CRITICAL: 'bg-radar-red/10 text-radar-red border-radar-red/30',
  HIGH: 'bg-radar-amber/10 text-radar-amber border-radar-amber/30',
  MEDIUM: 'bg-radar-blue/10 text-radar-blue border-radar-blue/30',
  LOW: 'bg-white/5 text-radar-text-muted border-white/10',
  critical: 'bg-radar-red/10 text-radar-red border-radar-red/30',
  high: 'bg-radar-amber/10 text-radar-amber border-radar-amber/30',
  medium: 'bg-radar-blue/10 text-radar-blue border-radar-blue/30',
  low: 'bg-white/5 text-radar-text-muted border-white/10',
